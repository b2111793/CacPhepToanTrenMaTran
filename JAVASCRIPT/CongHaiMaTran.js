...
import {NhapMaTran, LuuMaTran, InMaTran, CongHaiMaTran} from './functions.js';
...
var HienThiTong = document.getElementById('HienThiTong');

Cong.addEventListener('click', function(){
    if((rows1 === rows2) && (cols1 === cols2)){
        InMaTran(CongHaiMaTran(MaTran1, MaTran2), HienThiTong);
    }
    else{
        CongHaiMaTran(MaTran1, MaTran2);
        HienThiTong.innerHTML = "";
    }
});
