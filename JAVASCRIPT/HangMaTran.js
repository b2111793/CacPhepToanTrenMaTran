...
import {NhapMaTran, LuuMaTran, InMaTran, HangMaTran} from './functions.js';
...
// TÍNH HẠNG MA TRẬN
var TinhHang = document.getElementById('TinhHang');
var HienThiHang = document.getElementById('HienThiHang');
var HienThiMaTranKetQua2 = document.getElementById('HienThiMaTranKetQua2');

TinhHang.addEventListener('click', function(){
    InMaTran(MaTran1, HienThiMaTranKetQua2);
    InMaTran(HangMaTran(MaTran1)[1], HienThiMaTranTinhHang);
    HienThiHang.innerHTML = ` rank(A) = rank(A') = ` + HangMaTran(MaTran1)[0];
});
