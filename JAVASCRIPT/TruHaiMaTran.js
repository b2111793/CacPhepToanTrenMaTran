...
import {NhapMaTran, LuuMaTran, InMaTran, TruHaiMaTran} from './functions.js';
...
var HienThiHieu = document.getElementById('HienThiHieu');

Tru.addEventListener('click', function(){
    if((rows1 === rows2) && (cols1 === cols2)){
        InMaTran(TruHaiMaTran(MaTran1, MaTran2), HienThiHieu);
    }
    else{
        TruHaiMaTran(MaTran1, MaTran2);
        HienThiHieu.innerHTML = "";
    }
});
