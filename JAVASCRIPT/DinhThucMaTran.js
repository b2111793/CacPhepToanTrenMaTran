...
import {NhapMaTran, LuuMaTran, InMaTran, DinhThucMaTran} from './functions.js';
...
// TÍNH ĐỊNH THỨC
var TinhDinhThuc = document.getElementById('TinhDinhThuc');
var HienThiKetQuaTinhDinhThuc = document.getElementById('HienThiKetQuaTinhDinhThuc');
TinhDinhThuc.addEventListener('click', function(){
    HienThiKetQuaTinhDinhThuc.innerHTML = DinhThucMaTran(MaTran1);
});
